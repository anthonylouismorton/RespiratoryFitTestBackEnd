...
async function getEmployeeQuantitativeFitTests(employeeID) {
    try {
        ...
        console.log(employeeFitTests)
        return employeeFitTests.recordset[0]
    }
    catch(err){
        console.log(err)
    }
...
async function deleteQuantitativeFitTest(quantitativeTestID) {
    ...
    try {
        ...
        console.log(Object.values(quantitativeFitTest.recordset[0]))
...
async function updateQuantitativeFitTest(updateQuantitativeFitTest) {
    try {
        ...
        console.log(updatedQuantitativeFitTest)
